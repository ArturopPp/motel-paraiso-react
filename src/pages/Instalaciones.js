...
const fotosGaleria = [
  {
    id: 1,
    titulo: "Entrada Discreta y Segura",
  ...
  {
    id: 3,
    titulo: "Bar y Servicio a la Habitación",
  ...
  },
  {
    ...
    url: "https://images.pexels.com/photos/261394/pexels-photo-261394.jpeg?auto=compress&cs=tinysrgb&w=800",
  },
  {
    id: 5,
    titulo: "Detalles de Lujo",
  ...
  return (
    <main className="instalaciones-page">
      <div className="instalaciones-header">
        ...
        <p>
          Conoce los espacios diseñados para tu total comodidad y privacidad.
        </p>
      </div>
